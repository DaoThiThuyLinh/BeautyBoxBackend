...
public class PaymentResultController {
    ...
    public String onlinePaymentResult(@RequestParam Map<String, String> params,
                                      Model model,
                                      HttpServletRequest httpServletRequest) throws BeautyBoxException, UnsupportedEncodingException {
        String value = orderService.executePaymentResult(params, httpServletRequest);
